...
public extension UIViewController{
    ...
    func DeleteInputPhoto(显示时间:Double = 1.5,AlertTitle:String = "是否删除".localized(),imageName:String = "",Content:String = "是否删除已导入照片在相册中的原照片".localized(),OKBTN: (()->Void)? = nil,Failed: (()->Void)? = nil) {
