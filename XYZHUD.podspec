#
#  Be sure to run `pod spec lint XYZHUD.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "10.1"
  s.source       = { :git => "https://github.com/brandy2015/XYZHUD.git", :tag => "1.0.12"}
...
#s.resources = "ADVProgressBar/Resources/*.png"
    ...
    s.resource_bundles = {
        'XYZHUD' => ['XYZHUD/Assets/*.{png,xib}','XYZHUD/Source/Custom/Popup/*.xib','XYZHUD/Source/XYZHUDPic.bundle'],
    }
...
#{ :git => "http://EXAMPLE/XYZHUD.git", :tag => "#{s.version}" }
...
#s.source_files  = "XYZHUD"#, "XYZHUD/**/*.{h,m}"
